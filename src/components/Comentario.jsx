...
const Comentario = ({puntoVerde, nombreUsuario, fecha, comentario, calificacion, hora, posicion, setComentarios, comments}) => { //Element tiene los atributos de cada cita + su key
    ...
    <div className="comentario container flex" style={{ border: "2px solid green", backgroundColor: "rgb(58, 163, 102)", borderRadius: "2px", marginTop: "1rem", marginBottom: "1rem", marginRight: "3rem", color: "white", opacity: "70%", maxWidth: "100%"}}>
